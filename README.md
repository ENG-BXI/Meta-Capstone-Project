...
إذا بتستخدمه في **GitHub للتسليم حق Coursera**، أقدر كمان أخليه README احترافي أكثر بإضافة **Screenshots + Demo + Installation + Testing + Project Requirements** بدون ما يكون مبالغ فيه.
```
